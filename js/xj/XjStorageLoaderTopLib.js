...
(function() {
	...
	/*========================================================
	 コンストラクタAS02693
	========================================================*/
	XjStorageLoaderIrLib = function(s)
	{
		var defaults =
		{
		...
		XjStorageLoaderIrLib.prototype.init.call(this);
 	};

	/*========================================================
	 初期設定
	========================================================*/
	XjStorageLoaderIrLib.prototype.init = function()
	{
	...
	/*========================================================
	 表示処理
	========================================================*/
	XjStorageLoaderIrLib.prototype.show = function()
	{
		...
		function ( data )
		{
			...
			$('.ir_library_container').append ( cont ) ;
			$('.ir_library_container').slick({
		    infinite: false,
		    accessibility: false,
		    arrows: false,
		    variableWidth: true
	    ...
	    if (width <= 767) {
	      $('.ir_library_container').not('.slick-initialized').slick({
	        infinite: false,
	        accessibility: false,
	        arrows: false,
	        variableWidth: true
	      ...
	      $('.ir_library_container').slick('unslick');
	    }
		});
	}
...
$(function(){
		var xj_storage_loader = new XjStorageLoaderIrLib();
	});
